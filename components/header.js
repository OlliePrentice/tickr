...
export default function Header() {
    return (
        <>
            <div id="header">
                <div className="bg-white border-b border-gray-200 top-0 inset-x-0 z-100 items-center z-50">
                    <div className="pt-2 pb-2 w-full max-w-screen-xl relative mx-auto px-6">
                        <div className="flex items-center -mx-6">
                            <div className="lg:w-1/4 xl:w-1/5 pl-6 pr-6 lg:pr-8">
                                <div className="flex items-center">
                                    <Link href="/">
                                        <a className="block lg:mr-4 text-3xl text-gray-700 leading-3" href="/">
                                            <FontAwesomeIcon icon="chart-line"
                                                             className="text-green-400 mr-2 align-middle"/><span
                                            className="text-2xl align-middle">tickr</span>
                                        </a>
                                    </Link>
                                </div>
                            </div>
                            <div className="flex flex-grow min-w-0 lg:w-3/4 xl:w-4/5">
                                ...
                                <div className="hidden lg:flex lg:items-center lg:justify-between xl:w-1/4 px-6">
                                    ...
                                    <div className="flex justify-start items-center text-gray-500"><a
                                    ...
                                    </a><a className="block flex items-center hover:text-gray-700 mr-5"
                                    ...
                                    </a><a className="block flex items-center hover:text-gray-700" href="/discord">
                                        <svg className="fill-current w-5 h-5" xmlns="http://www.w3.org/2000/svg"
                                             viewBox="0 0 146 146"><title>Discord</title>
                                            <path
            ...
            <div className="bg-gray-700 shadow text-white font-semibold pt-1 pb-1 text-sm sticky top-0 z-50">
                <Ticker mode="smooth">
                    {({index}) => (
                        <>
